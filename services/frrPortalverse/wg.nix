...
in
{
  ...
  networking.wireguard.interfaces = import peers/tunnels.nix rec {
    ...
    tunnelc4 = listenPort: privateKey: publicKey: endpoint: name: tunnelIPv4: tunnelIPv6: localIPv4: customTunnel listenPort privateKey publicKey endpoint name tunnelIPv4 tunnelIPv6 localIPv4 defaultLocalIPv6;
    rip = listenPort: privateKey: publicKey: endpoint: name: tunnelIPv4: tunnelIPv6: ULAIPv6: customTunnel listenPort privateKey publicKey endpoint name tunnelIPv4 tunnelIPv6 defaultLocalIPv4 ULAIPv6;
  };
}
